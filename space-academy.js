...
const translations = {
  zh: {
    ...
    'sa.tw.wang.p':  '生於中華民國昆明，幼年隨家人遷居台灣，就讀台南成功高中，後赴美取得博士學位。1985 年以 NASA 酬載專家身分搭乘挑戰者號太空梭執行 STS-51-B 任務，成為<strong>史上第一位進入太空的華裔人士</strong>。任務中他同時攜帶了中華人民共和國國旗與中華民國國旗——後者因遭中共駐美大使館明令禁止，他<strong>將國旗藏於內衣中秘密帶上太空</strong>，返回後親手呈交時任行政院長俞國華。',
  ...
  en: {
    ...
    'sa.tw.wang.p':  'Born in Kunming, Republic of China, Wang grew up in Taiwan, attended Tainan\'s Cheng Kung High School, then earned a doctorate in the U.S. In 1985, he flew on the Space Shuttle Challenger (STS-51-B) as a NASA payload specialist, becoming the <strong>first person of Chinese descent to reach space</strong>. He carried both a PRC flag and an ROC flag — the latter forbidden by the PRC embassy in Washington. He <strong>concealed the ROC flag in his underwear to smuggle it aboard</strong>, then personally presented it to ROC Premier Yu Kuo-hwa upon his return.',
