...
const translations = {
  zh: {
    ...
    'sa.tw.wang.p':  '生於中國昆明，幼年隨家人遷居台灣，就讀台南成功高中，後赴美取得博士學位。1985 年以 NASA 酬載專家身分搭乘挑戰者號太空梭執行 STS-51-B 任務，成為<strong>史上第一位進入太空的華裔人士</strong>。其成長背景與求學經歷（成功中學、台灣大學）使他被台灣廣泛視為代表性人物。',
    'sa.tw.chiao.p': '生於美國密爾瓦基，父母來自中國。執行 4 次太空任務，並擔任 ISS 第 10 屆遠征隊指揮官（2004–2005），是<strong>首位擔任 ISS 指揮官的亞裔人士</strong>，也是首位以亞裔身分進行太空漫步的太空人（1996 年）。',
  ...
  en: {
    ...
    'sa.tw.wang.p':  'Born in Kunming, China, Wang grew up in Taiwan (ROC), attended Tainan\'s Cheng Kung High School, then earned a doctorate in the U.S. In 1985, he flew on the Space Shuttle Challenger (STS-51-B) as a NASA payload specialist, becoming the <strong>first person of Chinese descent to reach space</strong>. His upbringing and education in Taiwan make him a widely recognized symbol for the island.',
    'sa.tw.chiao.p': 'Born in Milwaukee to Chinese parents, Leroy Chiao flew four space missions and commanded ISS Expedition 10 (2004–2005), becoming the <strong>first Asian to command the ISS</strong> and the first Asian to perform a spacewalk (1996).',
