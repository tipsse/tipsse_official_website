...
const translations = {
  zh: {
    ...
    'sa.tw.banner.h3': '中華民國籍太空人：目前 0 人，但台灣出生者已上太空',
    'sa.tw.banner.p':  '截至 2025 年，尚無持有中華民國（台灣）現行國籍的人正式以太空人身分抵達 100 公里以上高空。然而，出生於台北的 Kjell Lindgren 以美國籍 NASA 太空人身分，累計在太空停留 311 天，是台灣土地上出生的第一位太空人。',
    'sa.tw.badge.wang':  '最具台灣淵源',
    'sa.tw.badge.chiao':   '美國籍（中華民國裔）',
    'sa.tw.badge.lindgren':'生於台北',
    'sa.tw.badge.flag':    '旗幟之旅',
    'sa.tw.lindgren.p': '1973 年生於台北，父親為美國空軍軍官，母親為台灣人。NASA 第 20 批次太空人，曾執行兩次任務、累計在太空停留 <strong>311 天</strong>，並擔任 SpaceX Crew-4 指揮官（2022）。是迄今<strong>出生在台灣土地上、真正進入太空的第一人</strong>。',
    ...
    'sa.tw.flag.p':   '<strong>第一次｜1965 年 12 月・Gemini VI</strong><br>NASA 太空人 Wally Schirra 搭乘雙子星六號進入太空，攜帶了中華民國國旗，那是<strong>中華民國國旗首次進入太空</strong>。冷戰時期美台關係的歷史見證，國旗附有 Schirra 親筆題詞。<br><br><strong>第二次｜1985 年 4 月・STS-51-B</strong><br>王贛駿執行挑戰者號任務期間，在外交環境複雜、攜帶國旗有所不便的情況下，仍以個人方式低調將國旗帶上太空，任務結束後親手呈交時任行政院長俞國華。',
  ...
  en: {
    ...
    'sa.tw.banner.h3': 'ROC-Nationality Astronauts: 0 — but one was born in Taiwan',
    'sa.tw.banner.p':  'As of 2025, no person holding current ROC (Taiwan) nationality has officially reached space. However, Kjell Lindgren — born in Taipei to a Taiwanese mother — flew as a NASA astronaut and spent 311 cumulative days in space, making him the first person born on Taiwanese soil to reach space.',
    'sa.tw.badge.wang':  'Strongest Taiwan Ties',
    'sa.tw.badge.chiao':   'American (ROC Heritage)',
    'sa.tw.badge.lindgren':'Born in Taipei',
    'sa.tw.badge.flag':    'Flag Journey',
    'sa.tw.lindgren.p': 'Born in Taipei in 1973 to a U.S. Air Force officer father and a Taiwanese mother. Selected as a NASA astronaut in 2009, he has completed two missions with a cumulative <strong>311 days in space</strong>, commanding SpaceX Crew-4 in 2022. He is the <strong>first person born on Taiwanese soil to have reached space</strong>.',
    ...
    'sa.tw.flag.p':   '<strong>1st time｜December 1965 · Gemini VI</strong><br>NASA astronaut Wally Schirra carried the ROC flag aboard Gemini VI — <strong>the first time the ROC flag entered space</strong>. A Cold War–era symbol of US–Taiwan ties, with Schirra\'s personal inscription on the flag.<br><br><strong>2nd time｜April 1985 · STS-51-B</strong><br>During his Challenger mission, Taylor Wang quietly brought the ROC flag to space as a personal gesture, navigating a diplomatically sensitive environment with discretion. Upon his return, he personally presented the flag to ROC Premier Yu Kuo-hwa.',
