...
const translations = {
  ...
  en: {
    ...
    'cal.section.p':    'TIPSSE events and ROC public holidays.',
...
function applyLang(lang) {
  ...
  // 會員專區目前停用（見 member.js）。保留此掛鉤，日後重新載入 member.js
  // 即可自動接回語言切換，不必再改這裡。
...
// ══════════════════════════════════════════════════════════════════════
// 會員專區已移出至 member.js（暫停開發，未被任何頁面載入）
// 移除原因與日後接後端的作法，見 member.js 開頭說明。
// ══════════════════════════════════════════════════════════════════════
